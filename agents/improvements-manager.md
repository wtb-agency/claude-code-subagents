...
- **Code health** (duplication, missing docs/typing, dead code) → proposals for python-pro-software-engineer.
...
- Ask at most one clarification question; otherwise escalate via orchestrator.
